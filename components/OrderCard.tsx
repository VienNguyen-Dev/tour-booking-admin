      ...
      {orders.map((order: Order, index) => (
        <div key={index} className="flex flex-col gap-4 mt-2">
          <div className="relative w-full h-fit rounded-md shadow-[#2F2B3D24] shadow-md bg-white p-3">
            ...
            <div className="absolute -top-2 left-2 bg-[#014C4633] border-[0.5px] border-[#014C46] py-[4px] px-[10px] max-w-[200px] h-[24px] w-fit rounded-[4px] text-[#014C46] font-medium text-sm flex items-center justify-start">
              {order?.$id}
            </div>
          </div>
        </div>
